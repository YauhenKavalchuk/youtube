...
В связи с блокировкой ресурса на территории РБ доступен **ТОЛЬКО загруженный на платформу контент (выпуски #35-#44)**.
...
_P.S. в этом случае происходит разовая оплата в 50$. Вы получаете доступ ко всем закрытым видео, а так же ко всем новым видео, которые будут появляться на канале._
